...
export default class App extends Component<Props, State> {
  ...
  render() {
    ...
    if (tool === 'remove' && selected && BackgroundRemoval) return <BackgroundRemoval file={selected.currentFile} onBack={() => this.setState({ tool: 'home' })} onResult={(file, next) => { this.updateCurrent(file, selected.id); this.setState({ tool: next === 'collage' ? 'collage' : 'home' }); }} />;
